...
<CardGroup cols={2}>
  <Card title="Framework aware" icon="blocks" href="/installation">
...
<Tip>
  Start with the [installation guide](/installation) and choose your framework. Mintlify will keep matching tab choices in sync across the page.
</Tip>
